...
class Library:
    ...
    def get_next_book_id(self) -> int:
        ...
        для добавления новой книги в библиотеку.
        При этом если книг в библиотеке нет, то возвращается 1,
        а если книги есть, то возвращается идентификатор последней книги увеличенный на 1.
        """
        if not self.books:
            return 1
        else:
    ...
    def get_index_by_book_id(self, id_: int):
        ...
        for index, boo in enumerate(self.books):
            if id_ is not boo.id_:
